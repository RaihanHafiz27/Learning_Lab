    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                if (!response.ok) {
                    throw new Error("request failed status : ".concat(response.status));
                }
                console.log("Success!!");
                return [3 /*break*/, 3];
            case 2:
...
var replaceData = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, fetch("".concat(URLAPI, "/1"), {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
...
var partialUpdateData = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, fetch("".concat(URLAPI, "/2"), {
                        method: "PATCH",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify({
                            name: "Alexa Tokyo",
...
var deletData = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, fetch("".concat(URLAPI, "/4"))];
            case 1:
                response = _a.sent();
                if (!response.ok) {
                    throw new Error("request failed status : ".concat(response.status));
